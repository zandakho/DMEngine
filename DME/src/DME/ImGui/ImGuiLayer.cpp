...
namespace DME
{
	...
	void ImGuiLayer::OnAttach()
	{
		...
		ImGui::GetStyle().Colors[ImGuiCol_WindowBg]							= ImColor(30, 30, 30, 255);
		ImGui::GetStyle().Colors[ImGuiCol_ChildBg]							= ImColor(20, 20, 20, 255);
		ImGui::GetStyle().Colors[ImGuiCol_PopupBg]							= ImColor(35, 35, 35, 255);
		ImGui::GetStyle().Colors[ImGuiCol_Border]							= ImColor(40, 40, 40, 255);
		ImGui::GetStyle().Colors[ImGuiCol_BorderShadow]						= ImColor(0, 0, 0, 0);
		ImGui::GetStyle().Colors[ImGuiCol_FrameBg]							= ImColor(11, 11, 11, 255);
		ImGui::GetStyle().Colors[ImGuiCol_FrameBgHovered]					= ImColor(16, 16, 16, 255);
		ImGui::GetStyle().Colors[ImGuiCol_FrameBgActive]					= ImColor(11, 11, 11, 255);
		ImGui::GetStyle().Colors[ImGuiCol_TitleBg]							= ImColor(10, 10, 10, 255);
		ImGui::GetStyle().Colors[ImGuiCol_TitleBgActive]					= ImColor(10, 10, 10, 255);
		ImGui::GetStyle().Colors[ImGuiCol_TitleBgCollapsed]					= ImColor(10, 10, 10, 255);
		...
		ImGui::GetStyle().Colors[ImGuiCol_Button]							= ImColor(45, 45, 45, 255);
		ImGui::GetStyle().Colors[ImGuiCol_ButtonHovered]					= ImColor(50, 50, 50, 255);
		ImGui::GetStyle().Colors[ImGuiCol_ButtonActive]						= ImColor(45, 45, 45, 255);
		ImGui::GetStyle().Colors[ImGuiCol_Header]							= ImColor(40, 40, 40, 255);
		ImGui::GetStyle().Colors[ImGuiCol_HeaderHovered]					= ImColor(45, 45, 45, 255);
		ImGui::GetStyle().Colors[ImGuiCol_HeaderActive]						= ImColor(40, 40, 40, 255);
		ImGui::GetStyle().Colors[ImGuiCol_Separator]						= ImColor(40, 40, 40, 255);
		ImGui::GetStyle().Colors[ImGuiCol_SeparatorHovered]					= ImColor(45, 45, 45, 255);
		ImGui::GetStyle().Colors[ImGuiCol_SeparatorActive]					= ImColor(40, 40, 40, 255);
		ImGui::GetStyle().Colors[ImGuiCol_ResizeGrip]						= ImColor(0, 0, 0, 0);
		ImGui::GetStyle().Colors[ImGuiCol_ResizeGripHovered]				= ImColor(0, 0, 0, 0);
		ImGui::GetStyle().Colors[ImGuiCol_ResizeGripActive]					= ImColor(0, 0, 0, 0);
		ImGui::GetStyle().Colors[ImGuiCol_InputTextCursor]					= ImColor(220, 220, 220, 255);
		ImGui::GetStyle().Colors[ImGuiCol_Tab]								= ImColor(30, 30, 30, 255);
		ImGui::GetStyle().Colors[ImGuiCol_TabHovered]						= ImColor(35, 35, 35, 255);
		ImGui::GetStyle().Colors[ImGuiCol_TabSelected]						= ImColor(30, 30, 30, 255);
		ImGui::GetStyle().Colors[ImGuiCol_TabSelectedOverline]				= ImColor(0, 0, 0, 0);
		ImGui::GetStyle().Colors[ImGuiCol_TabDimmed]						= ImColor(30, 30, 30, 255);
		ImGui::GetStyle().Colors[ImGuiCol_TabDimmedSelected]				= ImColor(30, 30, 30, 255);
