...
namespace DME
{
	namespace ImGuiDMEEditor
	{
		...
		bool CardWithAssetType(const char* name_id, void* image, const char* type, const char* extension, const char* hint, const glm::vec2& uv0, const glm::vec2& uv1, const glm::vec4& tint_col, int flags, const glm::vec4& asset_type_color = {1.0f, 1.0f, 1.0f, 1.0f});
